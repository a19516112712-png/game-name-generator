...
const HUB_SLUGS = ["forest-names","pirate-names","knight-names","wizard-names","faction-names","tavern-names","ship-names","creature-names","monster-names","npc-names","dungeon-names","fantasy-city-names","character-name-generator","kingdom-names","clan-names","guild-names","dragon-names","demon-names","angel-names","vampire-names","orc-names","elf-names","empire-names"];
