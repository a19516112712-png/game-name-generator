...
const trendingSearches = [
  ...
  { label: "Tavern Name Generator", slug: "tavern-names" },
  { label: "Fantasy Tavern Names", slug: "fantasy-tavern-names" },
  { label: "D&D Tavern Names", slug: "dnd-tavern-names" },
  { label: "Dwarven Tavern Names", slug: "dwarven-tavern-names" },
  { label: "Medieval Tavern Names", slug: "medieval-tavern-names" },
  { label: "Faction Name Generator", slug: "faction-names" },
  { label: "Fantasy Faction Names", slug: "fantasy-faction-names" },
  { label: "Dark Faction Names", slug: "dark-faction-names" },
  { label: "Elven Faction Names", slug: "elven-faction-names" },
  { label: "Shadow Faction Names", slug: "shadow-faction-names" },
  { label: "Wizard Name Generator", slug: "wizard-names" },
  { label: "Fantasy Wizard Names", slug: "fantasy-wizard-names" },
  { label: "Dark Wizard Names", slug: "dark-wizard-names" },
  { label: "Arcane Wizard Names", slug: "arcane-wizard-names" },
  { label: "D&D Wizard Names", slug: "dnd-wizard-names" },
  { label: "Knight Name Generator", slug: "knight-names" },
  { label: "Fantasy Knight Names", slug: "fantasy-knight-names" },
  { label: "Dark Knight Names", slug: "dark-knight-names" },
  { label: "Holy Knight Names", slug: "holy-knight-names" },
  { label: "D&D Knight Names", slug: "dnd-knight-names" },
  { label: "Pirate Name Generator", slug: "pirate-names" },
  { label: "Fantasy Pirate Names", slug: "fantasy-pirate-names" },
  { label: "Dark Pirate Names", slug: "dark-pirate-names" },
  { label: "Cursed Pirate Names", slug: "cursed-pirate-names" },
  { label: "Pirate Captain Names", slug: "captain-pirate-names" },
];
