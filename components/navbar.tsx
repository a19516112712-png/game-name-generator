...
const links = [
  ...
  { href: "/tavern-names", label: "Taverns" },
  { href: "/faction-names", label: "Factions" },
  { href: "/wizard-names", label: "Wizards" },
  { href: "/knight-names", label: "Knights" },
  { href: "/pirate-names", label: "Pirates" },
